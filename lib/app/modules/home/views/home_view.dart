    ...
    return ClipPath(
      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          children: [
            GoImage(
              url: 'https://picsum.photos/seed/${HomeController.heroImageSeed}/1800/1400?grayscale',
            ),
            Container(
...
class _Manifesto extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final imageContent = ClipPath(
      ...
      child: AspectRatio(
        aspectRatio: 4 / 5,
        child: const GoImage(url: 'https://picsum.photos/seed/go-eyewear-about-story/900/1100'),
      ),
    );
...
class _ShapeGrid extends StatelessWidget {
  static const _shapes = [
    (label: 'AVIATOR', seed: 'go-eyewear-shape-aviator', shape: FrameShape.aviator),
    (label: 'ROUND', seed: 'go-eyewear-shape-round', shape: FrameShape.round),
    (label: 'CAT-EYE', seed: 'go-eyewear-shape-cat-eye', shape: FrameShape.catEye),
    (label: 'RECTANGLE', seed: 'go-eyewear-shape-rectangle', shape: FrameShape.rectangle),
  ];
...
class _ShapeTile extends StatefulWidget {
  ...
  const _ShapeTile({required this.label, required this.seed, required this.shape});
        ...
        child: Stack(
          ...
          children: [
            AnimatedScale(
              ...
              child: GoImage(url: 'https://picsum.photos/seed/${widget.seed}/700/900?grayscale'),
            ),
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
    ...
    return ClipPath(
      ...
      child: Container(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            GoImage(url: 'https://picsum.photos/seed/${HomeController.editorialImageSeed}/1600/1000?grayscale'),
